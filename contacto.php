...
<body>
	...
	<div id="fh5co-header">
        ...
        <input name="BUSCAR" type="text" value="BUSCAR" class="buscar">
        </div>
        <div class="lupaa"><img src="images/lupa2.png" width="100%" height="auto"></div>
        </div>
		<a href="login.html"><div class="inicia">INICIAR SESION</div></a>
	</div>
	
    <div class="parallax">
    <img src="images/slidermitad.jpg" width="100%" height="auto">
    </div>

	<div id="fh5co-contact-section">
		<div class="row">
			<div class="col-md-6">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15947.740974327911!2d-79.91995365740891!3d-2.178288147753282!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x902d13cbe855805f%3A0x8015a492f4fca473!2sGuayaquil!5e0!3m2!1ses!2sec!4v1516413003859" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
			</div>
			<div class="col-md-66">
				<div class="col-md-12">
					<h3>Contáctanos</h3>
				  ...
				  <?php require_once('php/datosContacto.php'); ?>
						<li><i class="ti-mobile"></i><?=$telefono?></li>
						<li><i class="ti-envelope"></i><a href="#"><?=$correo?></a></li>
						<li><i class="ti-home"></i><a href="#">https://exploreunique.org</a></li>
					</ul>
				</div>
				<div class="col-md-12">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<ul class="link">
                                ...
                                ?>
								<li><a href="destinos.php?id=<?php echo $rowmenu["idpaquetes_menu"] ?>"><?php echo $rowmenu["descripcion"] ?></a></li>
